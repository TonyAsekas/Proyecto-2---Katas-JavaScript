...
clasifícalas en un objeto donde las claves sean los géneros 
...
const tracks = [
 ...
 for (const track of tracks) {
    if(!classifiedTracks[track.genre]){
        classifiedTracks[track.genre] = []
    }
    classifiedTracks[track.genre].push(track)
